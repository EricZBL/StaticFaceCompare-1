...
//        for(Boolean res : res.getResult())
    ...
    public static void main(String args[]){
        ...
        compareClient.createService("172.18.18.202:2181");
        ...
        param.setFeatureBit(FaceUtil.base64Str2BitFeature("ANMPRlkre9R+W4T17Hn8gjJBCQoSV1XtNM8qU9lGHD0=")); // n3kXnhr5xvXNugR++Mw8tf2SApi1iF3giUIaM7YkxrA=
        param.setSim(70);
        SearchResult searchResult = compareClient.retrieval(param);
        System.out.println(searchResult.getRecords().length); //46ee10722a1a43499e15042cf3808a63
//        compareClient.delete("46ee10722a1a43499e15042cf3808a63", "100129933849509934");
        //d021c077bc5c4b2585397e67c8b47c51_nv8L1mug1FWfvgZWMUyqmO3SEbrX3wnx8kBaEvYm93Q=
//        compareClient.addData("d021c077bc5c4b2585397e67c8b47c51", "nv8L1mug1FWfvgZWMUyqmO3SEbrX3wnx8kBaEvYm93Q=", "100129933849509934");
    }
